                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <a href="{{ route('categories.create') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded inline-block">Agregar categorias </a>
                            <br>
                            <div>
                                @if(session('success'))
                            ...
                            <table class="w-full divide-y divide-gray-200 mt-4">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">titulo</th>
                                ...
                                <tbody>
                                    @foreach($data as $category)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-center">{{ $category->titulo }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-center align-middle">
                                                <div class="flex items-center">
                                                    <a href="{{ route('categories.edit', $category->id) }}" class="inline-block mr-4">
